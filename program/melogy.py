...
speaker = PWM(Pin(18, Pin.OUT)) # スピーカーを接続しているGPIO（この例では17番）を作成し、それをPWM()へ渡す
r_onboard = Pin(2, Pin.OUT) # 基板上のLEDを光らせたいのでGPIO25作成
y_onboard = Pin(3, Pin.OUT)
g_onboard = Pin(4, Pin.OUT)
b_onboard = Pin(5, Pin.OUT)
w_onboard = Pin(6, Pin.OUT)
